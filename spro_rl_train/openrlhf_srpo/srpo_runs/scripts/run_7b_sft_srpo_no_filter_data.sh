...
export RAY_MASTER_PORT=6678
export RAY_DASHBOARD_PORT=8278
export NCCL_TIMEOUT=7200
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7

# OUTPUT_DIR='/mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/output_ckpts/test_only'
OUTPUT_DIR='/opt/tiger/mariana/zhongwei_tmp_checkpoints/srpo_qwen_2_5vl_sft_lowmem_no_filter_data'
...
if [ "$NODE_RANK" -eq 0 ]; then
  ...
  --pretrain /mnt/hdfs/wanzhongwei/SR_SFT/output_dir_qwen_2_5_7B_srsft/checkpoint-1000 \
  ...
  --init_kl_coef 0.0 \
  --prompt_data /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/Dataset_and_models/modified_37K_release.jsonl \
  ...
  --wandb_run_name "srpo_full_version_test_new_random_test" \
...
# new_srpo_qwen_2_5vl_sft_lowmem_no_filter_data
# /mnt/hdfs/wanzhongwei/SR_SFT/output_dir_qwen_2_5_7B_srsft/checkpoint-1000
# huggingface-cli login
# sh examples/scripts/run_7b_sft_srpo_no_filter_data.sh
