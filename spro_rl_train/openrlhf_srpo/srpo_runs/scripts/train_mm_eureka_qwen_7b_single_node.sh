...
OUTPUT_DIR='/opt/tiger/mariana/zhongwei_tmp_checkpoints/srpo_qwen_2_5vl_sft_lowmem'
...
if [ "$NODE_RANK" -eq 0 ]; then
  ...
  --remote_rm_url examples/scripts/reward_func_qwen_instruct_N.py \
  --actor_num_nodes 1 \
  ...
  --pretrain /mnt/bn/seed-aws-va/zhongweiwan/SR_SFT/output_dir_qwen_2_5_7B_srsft/checkpoint-1000 \
  ...
  --wandb_run_name "new_srpo_qwen_2_5vl_sft_lowmem" \
