...
# CUDA_VISIBLE_DEVICES=0 python /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/MM-EUREKA/eval/k12/evaluate_k12.py
...
# /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/output_ckpts/outputs_2/ckpt/global_step550_hf

# python k12/extract_calculate.py --output_file /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/MM-EUREKA/eval/results/MMK12_250509051112.json
# python mathvision/extract_calculate.py --output_file /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/MM-EUREKA/eval/results/MathVision_test_250509044332.json
# python mathvista/extract_calculate.py --output_file /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/MM-EUREKA/eval/results/MathVista_testmini_250509045428.json
# python olympiadbench/extract_calculate.py --output_file /mnt/bn/seed-aws-va/zhongweiwan/SR_GRPO/MM-EUREKA/eval/results/OE_TO_physics_en_COMP_250509050538.json